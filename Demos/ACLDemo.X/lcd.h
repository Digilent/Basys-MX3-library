...
#define mskShiftRL 0x04		// bit for directtion 
...
//void LCD_SetWriteDdramPosition(unsigned char bAdr);
...
void LCD_WriteStringAtPos(char *szLn, int idxLine, unsigned char bAdr);
...
void LCD_WriteDataByte1(unsigned char bData);
void LCD_WriteStringAtPos1(const char *szLn, int idxLine, unsigned char idxPos);
