...
/** Descriptive File Name
  ...
  @Description
    ...
    Mode 0 (play sine) - Generate sound using a sine wave. Features:
        - PWM is produced using OC1, at a frequency of 48 kHz given by Timer3.
    Mode 1 (mirror) - Acquires samples from MIC and generates Audio output accordingly, live. Features:
     ...
     Mode 3 (play recorded) - Play the values from a buffer to the Audio output. Features:
...
**		This is the interrupt handler for Timer3. According to each mode, it is called at specific frequencies, as initialized in AUDIO_Init.
    Mode 0 (play sine) - Advance current index in the sine definition buffer, initialize OC1 with the current sine definition value:
...
**
**	Description:
**		This function initializes the AUDIO module, in a specific mode indicated by parameter bMode. 
...
**      Mode 0 (play sine) - Timer3 is initialized at a frequency of 48 kHz. The playback is initialized with the sine definition string.
...
**
**	Description:
**		This function initializes the playback buffer, by providing a pointer to the 2 byte values array and the buffer dimension.
**      
**          
*/
...
**
**	Description:
**		This function initializes the record buffer, by providing a pointer to the 2 byte values array and the buffer dimension.
**      
**          
*/
